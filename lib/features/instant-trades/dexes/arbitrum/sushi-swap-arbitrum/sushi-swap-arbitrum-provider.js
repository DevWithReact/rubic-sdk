...
var sushi_swap_arbitrum_trade_1 = require("./sushi-swap-arbitrum-trade");
var constants_1 = require("./constants");
var SushiSwapArbitrumProvider = /** @class */ (function (_super) {
    __extends(SushiSwapArbitrumProvider, _super);
    function SushiSwapArbitrumProvider() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.blockchain = BLOCKCHAIN_NAME_1.BLOCKCHAIN_NAME.ARBITRUM;
        _this.InstantTradeClass = sushi_swap_arbitrum_trade_1.SushiSwapArbitrumTrade;
        _this.providerSettings = constants_1.SUSHI_SWAP_ARBITRUM_PROVIDER_CONFIGURATION;
        return _this;
    }
    return SushiSwapArbitrumProvider;
