...
var OneinchTrade = /** @class */ (function (_super) {
    ...
    Object.defineProperty(OneinchTrade.prototype, "type", {
        get: function () {
            return OneinchTrade.oneInchTradeTypes[this.from.blockchain];
        },
        enumerable: false,
        configurable: true
    });
    ...
    OneinchTrade.prototype.specifyError = function (err) {
        ...
        if (err.error) {
            ...
            if ((_b = err.error.message) === null || _b === void 0 ? void 0 : _b.includes('insufficient funds for transfer')) {
                throw new insufficient_funds_oneinch_error_1.InsufficientFundsOneinchError();
            }
    ...
    OneinchTrade.oneInchTradeTypes = (_a = {},
        _a[BLOCKCHAIN_NAME_1.BLOCKCHAIN_NAME.ETHEREUM] = trade_type_1.TRADE_TYPE.ONE_INCH_ETHEREUM,
        _a[BLOCKCHAIN_NAME_1.BLOCKCHAIN_NAME.BINANCE_SMART_CHAIN] = trade_type_1.TRADE_TYPE.ONE_INCH_BSC,
        _a[BLOCKCHAIN_NAME_1.BLOCKCHAIN_NAME.POLYGON] = trade_type_1.TRADE_TYPE.ONE_INCH_POLYGON,
        _a);
    __decorate([
        common_1.Cache
