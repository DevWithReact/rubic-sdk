        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        swapTradeParams = {
                            params: __assign(__assign({}, quoteTradeParams.params), { slippage: (options.slippageTolerance * 100).toString(), fromAddress: this.walletAddress, disableEstimate: options.gasCalculation === 'disabled' })
                        };
