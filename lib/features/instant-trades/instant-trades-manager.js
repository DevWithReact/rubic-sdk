...
var oneinch_arbitrum_provider_1 = require("./dexes/arbitrum/oneinch-arbitrum/oneinch-arbitrum-provider");
...
var InstantTradesManager = /** @class */ (function () {
    function InstantTradesManager() {
        ...
        this.algebraTradeProviders = [algebra_provider_1.AlgebraProvider];
        this.tradeProviders = __spreadArray(__spreadArray(__spreadArray(__spreadArray(__spreadArray([], this.uniswapV2TradeProviders, true), this.uniswapV3TradeProviders, true), this.oneInchTradeProviders, true), this.zrxTradeProviders, true), this.algebraTradeProviders, true).reduce(function (acc, ProviderClass) {
