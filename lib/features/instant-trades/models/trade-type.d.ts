export declare const TRADE_TYPE: {
    ...
    readonly UNI_SWAP_V3_ETHEREUM: "UNI_SWAP_V3_ETHEREUM";
    readonly UNI_SWAP_V3_POLYGON: "UNI_SWAP_V3_POLYGON";
    readonly ONE_INCH_ETHEREUM: "ONE_INCH_ETHEREUM";
    readonly ONE_INCH_BSC: "ONE_INCH_BSC";
    readonly ONE_INCH_POLYGON: "ONE_INCH_POLYGON";
    readonly ONE_INCH_ARBITRUM: "ONE_INCH_ARBITRUM";
    readonly ZRX_ETHEREUM: "ZRX_ETHEREUM";
    readonly ALGEBRA: "ALGEBRA";
    readonly VIPER_SWAP: "VIPER_SWAP";
    readonly SUSHI_SWAP_ARBITRUM: "SUSHI_SWAP_ARBITRUM";
    readonly UNI_SWAP_V3_ARBITRUM: "UNI_SWAP_V3_ARBITRUM";
