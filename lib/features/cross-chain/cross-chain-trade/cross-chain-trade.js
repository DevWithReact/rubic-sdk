...
var CrossChainTrade = /** @class */ (function () {
    function CrossChainTrade(crossChainTrade, providerAddress) {
        ...
        var fromSlippage = this.fromTrade instanceof it_cross_chain_contract_trade_1.ItCrossChainContractTrade
            ? this.fromTrade.slippageTolerance
            : 0;
        this.to = new price_token_amount_1.PriceTokenAmount(__assign(__assign({}, this.toTrade.toToken.asStruct), { weiAmount: this.toTrade.toToken.weiAmount.dividedBy(1 - fromSlippage).dp(0) }));
    ...
    CrossChainTrade.prototype.checkToContractBalance = function () {
        return this.toWeb3Public.checkBalance(this.toTrade.fromToken, this.fromTrade.fromToken.tokenAmount, this.toTrade.contract.address);
    };
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, fromTrade.getMethodArguments(toTrade, this.walletAddress, this.providerAddress)];
                    case 1:
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, web3_pure_1.Web3Pure.encodeMethodCall(contractAddress, contractAbi, methodName, methodArguments, value, {
